...
const SOCIALS = [
  {
    name: "Facebook",
    desc: "Follow us for official public notices, trust coordinates, drive reviews, and community assemblies.",
    icon: (
  ...
  {
    name: "Instagram",
    desc: "Check out visual portfolios of our weekly tree planting drives, health checkups, and desk distributions.",
    icon: (
      <svg className="w-8 h-8 text-saffron fill-none stroke-current" viewBox="0 0 24 24" strokeWidth="2">
  ...
  {
    name: "YouTube",
    desc: "Tune in for live festival coverage, cultural program broadcasts, and documentary reels.",
    icon: (
      <svg className="w-8 h-8 text-saffron fill-none stroke-current" viewBox="0 0 24 24" strokeWidth="2">
  ...
  {
    name: "Twitter (X)",
    desc: "Receive fast, real-time alerts, coordination coordinates, and dry food distribution locations.",
    icon: (
      <svg className="w-8 h-8 text-saffron fill-none stroke-current" viewBox="0 0 24 24" strokeWidth="2">
