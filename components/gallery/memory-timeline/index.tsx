...
export default function MemoryTimeline() {
  ...
  return (
    <section 
      ref={containerRef} 
      className="py-12 sm:py-16 md:py-24 px-4 sm:px-6 md:px-12 relative overflow-hidden bg-white/40 border-y border-saffron/10"
    >
          ...
          <div className="space-y-8 sm:space-y-12 md:space-y-16">
            {LOGS.map((item, index) => {
              ...
              return (
                ...
                >
                  {/* Saffron bullet */}
                  <div className="absolute left-4 md:left-1/2 w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-white border-4 border-saffron -translate-x-1/2 z-10" />
