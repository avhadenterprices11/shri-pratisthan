                      ...
                      >
                        ...
                        <div className="relative h-44 sm:h-52 w-full overflow-hidden bg-neutral-100 dark:bg-neutral-900">
                          ...
                          <div className="absolute top-4 right-4">
                            <span
                              className={`px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider backdrop-blur-md shadow-md ${event.status === "upcoming"
                          ...
                          <div className="absolute top-3 sm:top-3.5 right-3 sm:right-3.5">
                            <span
                              className={`px-2.5 py-0.5 sm:py-1 rounded-full text-[9px] sm:text-[10px] font-bold uppercase tracking-[0.18em] backdrop-blur-md shadow-md font-sans ${event.status === "upcoming"
                                  ? "bg-emerald-500 text-white"
                                  : event.status === "active"
                                    ? "bg-amber-500 text-white animate-pulse"
                                    : "bg-black/60 text-neutral-300 border border-white/20"
