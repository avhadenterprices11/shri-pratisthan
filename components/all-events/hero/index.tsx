...
export default function AllEventsHero() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative min-h-[55vh] sm:min-h-[60vh] flex flex-col justify-center items-center text-center px-4 sm:px-6 md:px-12 pt-24 sm:pt-28 pb-10 sm:pb-12 overflow-hidden select-none bg-[#FBFBFA] text-neutral-900"
    >
      ...
      <div className="relative z-20 max-w-5xl mx-auto space-y-4 sm:space-y-6 flex flex-col items-center">
        {/* Animated Badge Tag */}
        <div className="hero-title-reveal inline-flex items-center gap-2 px-4 sm:px-5 py-1.5 sm:py-2 rounded-full bg-white/95 border border-saffron/40 text-saffron font-bold text-[9px] sm:text-xs uppercase tracking-[0.2em] backdrop-blur-md shadow-lg font-sans">
