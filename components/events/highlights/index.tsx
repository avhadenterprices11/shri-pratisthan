...
const HIGHLIGHTS: HighlightItem[] = [
  {
    num: "01",
    title: "Cultural Heritage Parades",
    category: "Dhol Tasha Processions",
  ...
  {
    num: "02",
    title: "Emergency Health Camps",
    category: "Diagnostic Counseling",
    video: "",
  ...
  {
    num: "03",
    title: "Notebook Distribution Drives",
