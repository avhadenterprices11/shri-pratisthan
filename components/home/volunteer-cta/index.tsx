...
export default function VolunteerCTA() {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-5xl mx-auto relative z-10 volunteer-trigger-content">
        <div className="glass-panel p-8 sm:p-16 rounded-block text-center border border-saffron/20 relative overflow-hidden bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-orange-50 via-white to-white">
          ...
          <div className="relative z-10">
            <span className="text-saffron font-bold text-xs uppercase tracking-widest block mb-4">Be the Change</span>
            ...
            <p className="text-base sm:text-lg text-slate-grey max-w-xl mx-auto mb-10 leading-relaxed">
              We are looking for coordinators, medical professionals, disaster assistants, and cultural musicians. Dedicate a portion of your time to help build a stronger community.
            </p>
