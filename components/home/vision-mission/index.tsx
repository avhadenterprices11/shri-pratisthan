    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <span className="text-saffron font-bold text-[11px] uppercase tracking-[0.25em] block mb-3 font-sans">Our Foundations</span>
          <h2 className="text-3xl sm:text-5xl font-normal text-foreground tracking-tight font-heading leading-tight">
            Vision & Mission
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="vision-box glass-panel p-8 sm:p-12 rounded-block relative overflow-hidden group hover:border-saffron/30 transition-all duration-500">
            ...
            <div className="text-[11px] uppercase font-bold tracking-[0.22em] text-saffron mb-4 font-sans">The Vision</div>
            <h3 className="text-2xl sm:text-3xl font-normal text-foreground mb-5 font-heading leading-snug">
            ...
            <p className="text-sm text-slate-grey/80 leading-[1.7] font-sans">
          ...
          <div className="vision-box glass-panel p-8 sm:p-12 rounded-block relative overflow-hidden group hover:border-gold/30 transition-all duration-500">
            ...
            <div className="text-[11px] uppercase font-bold tracking-[0.22em] text-gold mb-4 font-sans">The Mission</div>
            <h3 className="text-2xl sm:text-3xl font-normal text-foreground mb-5 font-heading leading-snug">
