        ...
        <div className="max-w-[1600px] w-full mx-auto relative z-10">
          <div className="max-w-4xl space-y-4">
            ...
            <div className="pt-2 flex flex-wrap items-center gap-4 text-xs text-slate-500 dark:text-neutral-400 font-semibold">
              ...
              <span className="bg-white/80 dark:bg-white/5 border border-slate-200 dark:border-white/10 px-3 py-1.5 rounded-lg">Jurisdiction: Nashik, Maharashtra</span>
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="glass-panel p-8 sm:p-10 rounded-block bg-white dark:bg-[#121214] border border-saffron/15 dark:border-white/10 shadow-xl space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <span className="text-xs text-slate-400 dark:text-neutral-400 font-bold uppercase tracking-wider">Binding Agreement</span>
                </div>
              </div>
            ...
            <div className="glass-panel p-8 sm:p-10 rounded-block bg-white dark:bg-[#121214] border border-saffron/15 dark:border-white/10 shadow-xl space-y-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <span className="text-xs text-slate-400 dark:text-neutral-400 font-bold uppercase tracking-wider">Festival Discipline</span>
                </div>
              </div>
              <p className="text-sm sm:text-base text-slate-grey dark:text-neutral-300 leading-relaxed">
            ...
            <div className="glass-panel p-8 sm:p-10 rounded-block bg-white dark:bg-[#121214] border border-saffron/15 dark:border-white/10 shadow-xl space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <span className="text-xs text-slate-400 dark:text-neutral-400 font-bold uppercase tracking-wider">Athletic Brotherhood</span>
                </div>
              </div>
              <p className="text-sm sm:text-base text-slate-grey dark:text-neutral-300 leading-relaxed">
              ...
              <ul className="space-y-2 pt-2 text-sm sm:text-base text-slate-grey dark:text-neutral-300 list-disc pl-5">
            ...
            <div className="glass-panel p-8 sm:p-10 rounded-block bg-white dark:bg-[#121214] border border-saffron/15 dark:border-white/10 shadow-xl space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <span className="text-xs text-slate-400 dark:text-neutral-400 font-bold uppercase tracking-wider">Ethics of Seva</span>
                </div>
              </div>
              <p className="text-sm sm:text-base text-slate-grey dark:text-neutral-300 leading-relaxed">
            ...
            <div className="glass-panel p-8 sm:p-10 rounded-block bg-white dark:bg-[#121214] border border-saffron/15 dark:border-white/10 shadow-xl space-y-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <span className="text-xs text-slate-400 dark:text-neutral-400 font-bold uppercase tracking-wider">Legal Framework</span>
                </div>
              </div>
              <p className="text-sm sm:text-base text-slate-grey dark:text-neutral-300 leading-relaxed">
